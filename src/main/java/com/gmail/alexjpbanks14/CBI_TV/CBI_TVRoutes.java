...
public class CBI_TVRoutes {
	
	
	public static final String CONTROL_SECURE = "/secure";
	public static final String CONTROL_INDEX = "/index.html";
	public static final String CONTROL_LOGIN = "/login.html";
	public static final String CONTROL_TEST = "test.html";
	public static final String SOCKET_API_HANDLER = "/socket/sockethandler";
	...
	public static final String CONTROL_PANEL_SETUP = "/controlpanel/setup.html";
	public static final String CONTROL_PANEL_HELP = "/controlpanel/help.html";
